(()=>{var N=(C,k,e)=>new Promise((b,w)=>{var M=p=>{try{c(e.next(p))}catch(u){w(u)}},L=p=>{try{c(e.throw(p))}catch(u){w(u)}},c=p=>p.done?b(p.value):Promise.resolve(p.value).then(M,L);c((e=e.apply(C,k)).next())});window.chattermateId;window.ChatterMate;(function(){function C(t){return/^#[0-9A-F]{6}$/i.test(t)}function k(){return"https://api.chattermate.chat/api/v1"}let e={baseUrl:k(),containerId:"chattermate-container",buttonId:"chattermate-button",chatBubbleColor:"#f34611",loadingContainerId:"chattermate-loading",tokenKey:"ctid",containerBottom:100,containerRight:20,containerWidth:400,chatInitiationMessages:[],initiationMessageId:"chattermate-initiation",initiationShownKey:"ctim_shown"};function b(){let t=document.createElement("style");t.id="chattermate-styles",t.textContent=`
      #${e.buttonId} {
        position: fixed;
        bottom: 20px;
        right: 20px;
    ...
    `,document.body.appendChild(t),document.body.appendChild(i),document.body.appendChild(n),document.body.appendChild(a);let r=!1,s=null,z=!1,f=null;function A(){r=!r,i.classList.toggle("active"),t.classList.toggle("active"),n.classList.toggle("active"),r&&f&&(S(f),f=null,E()),c()?r?(t.classList.remove("mobile-closed"),t.style.animation=""):(t.classList.add("mobile-closed"),t.style.animation="chattermate-bounce 2.2s ease-in-out infinite",a.classList.remove("active"),document.body.classList.remove("ask-anything-mobile")):r&&n.classList.remove("active"),r&&s&&s.contentWindow.postMessage({type:"SCROLL_TO_BOTTOM"},"*")}function H(m){let x=document.createElement("div");x.className="chattermate-error-ui";let d=document.createElement("div");d.className="chattermate-error-card";let o=document.createElement("div");o.className="chattermate-error-icon-wrapper";let l=document.createElementNS("http://www.w3.org/2000/svg","svg");l.setAttribute("class","chattermate-error-icon"),l.setAttribute("viewBox","0 0 24 24"),l.setAttribute("fill","none"),l.setAttribute("stroke","currentColor"),l.setAttribute("stroke-width","1.5");let h=document.createElementNS("http://www.w3.org/2000/svg","path");h.setAttribute("d","M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z");let y=document.createElementNS("http://www.w3.org/2000/svg","path");y.setAttribute("d","M9 12l2 2 4-4"),l.appendChild(h),l.appendChild(y),o.appendChild(l);let T=document.createElement("h2");T.className="chattermate-error-title",T.textContent="Chat Unavailable";let $=document.createElement("p");$.className="chattermate-error-message",$.textContent=m;let v=document.createElement("div");v.className="chattermate-error-footer";let g=document.createElementNS("http://www.w3.org/2000/svg","svg");g.setAttribute("width","14"),g.setAttribute("height","14"),g.setAttribute("viewBox","0 0 60 60"),g.setAttribute("fill","none");let I=document.createElementNS("http://www.w3.org/2000/svg","path");I.setAttribute("d","M45 15H15C13.3431 15 12 16.3431 12 18V42C12 43.6569 13.3431 45 15 45H25L30 52L35 45H45C46.6569 45 48 43.6569 48 42V18C48 16.3431 46.6569 15 45 15Z"),I.setAttribute("fill","currentColor"),I.setAttribute("opacity","0.6"),g.appendChild(I);let _=document.createElement("span");return _.textContent="Powered by ChatterMate",v.appendChild(g),v.appendChild(_),d.appendChild(o),d.appendChild(T),d.appendChild($),d.appendChild(v),x.appendChild(d),x}function R(){return N(this,null,function*(){if(!(z||s))try{z=!0,t.classList.add("loading");let m=w(),x=`${e.baseUrl}/widgets/${window.chattermateId}/data?widget_id=${window.chattermateId}`,d={method:"GET",mode:"cors",headers:m?{Authorization:`Bearer ${m}`}:{}};fetch(x,d).then(o=>N(null,null,function*(){if(o.status===401)try{let h=(yield o.json()).detail||"";if(h.includes("generate-token")||h.includes("API key")||h.includes("Token must be obtained")){t.classList.remove("loading"),L();let y=H("This chat widget is not currently configured. Please contact the website administrator to enable chat support.");return i.appendChild(y),null}}catch(l){}if(!o.ok)throw new Error("HTTP error! status: "+o.status);return o.text()})).then(o=>{o!==null&&(s=document.createElement("iframe"),s.className="chattermate-iframe",s.srcdoc=o,i.appendChild(s),t.classList.remove("loading"),s.style.opacity="1")}).catch(o=>{console.error("Failed to load widget:",o),t.classList.remove("loading");let l=H("Unable to load chat. Please try again later.");i.appendChild(l)}),window.addEventListener("message",function(o){o.data.type==="TOKEN_UPDATE"&&s&&(M(o.data.token),s.contentWindow.postMessage({type:"TOKEN_RECEIVED",token:o.data.token},"*"))})}catch(m){console.error("Failed to load widget:",m),t.classList.remove("loading")}finally{z=!1}})}R(),setTimeout(()=>{!r&&e.chatInitiationMessages.length>0&&(f=F(),K(f,A))},2e3),t.addEventListener("click",A),n.addEventListener("click",A),c()&&!r&&(t.classList.add("mobile-closed"),t.style.animation="chattermate-bounce 2.2s ease-in-out infinite"),window.addEventListener("resize",function(){let m=c();m&&!r?(t.classList.add("mobile-closed"),t.style.animation="chattermate-bounce 2.2s ease-in-out infinite",n.classList.remove("active")):m||(t.classList.remove("mobile-closed"),t.style.animation="",r&&n.classList.remove("active")),b()})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",B):B(),window.addEventListener("message",function(t){if(t.data.type==="CUSTOMIZATION_UPDATE"){let i=t.data.data,n=i.chat_bubble_color;e.chatBubbleColor=C(n)?n:e.chatBubbleColor,i.chat_initiation_messages&&Array.isArray(i.chat_initiation_messages)&&(e.chatInitiationMessages=i.chat_initiation_messages),c()?i.chat_style==="ASK_ANYTHING"&&isOpen?(document.body.classList.add("ask-anything-mobile"),mobileTopbar.classList.add("active")):(document.body.classList.remove("ask-anything-mobile"),mobileTopbar.classList.remove("active")):i.chat_style==="ASK_ANYTHING"?(e.containerBottom=90,e.containerRight=20,e.containerWidth=400):(e.containerBottom=100,e.containerRight=20,e.containerWidth=400),b();let a=document.querySelector(`#${e.buttonId} .chat-icon path:last-child`);a&&a.setAttribute("fill",e.chatBubbleColor)}}),window.ChatterMate={init:function(t){t.baseUrl&&(e.baseUrl=t.baseUrl),window.chattermateId=t.id}}})();})();
